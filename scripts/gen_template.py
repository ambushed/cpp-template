...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Cpp Project Generator")
    parser.add_argument("-t", "--type", help="Target platform", choices=platforms, default="win32")
    ...
    parser.add_argument("--hello", help="Generates a full copy of the HelloWorld example targeting all platforms", action="store_true", default=False)
